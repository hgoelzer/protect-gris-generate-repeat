#!/usr/bin/env python
# Produce shuffled time series until 2300 based input until 2100
import xarray
import numpy
import netCDF4
import os
...
def main():
    time_index_filename = 'time_indices_2101-2300_ext10.nc'
    ...
    # repeat shuffel up to 2300 10*20
    for i in range(0,20):
